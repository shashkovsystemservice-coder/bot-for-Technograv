...
export const technogravSurvey = {
  ...
  isActive: true,
  questions: [
    { id: 'q0', text: 'Представьтесь, пожалуйста. Как вас зовут?' },
{ id: 'q00', text: 'Какая у вас должность?' }, 
    { id: 'q1', text: 'Кто наш «Топ-3» конкурентов по частоте встреч? Напишите названия 3-5 компаний, которые чаще всего уводят у нас сделки или с кем нас постоянно сравнивают клиенты.' },
    ...
    { id: 'q3', text: 'Кто уже «продаёт словами» автоматизацию (L1 ячейка -L2 участок - L3 линия)? Кто из конкурентов начал активно использовать в маркетинге слова «автоматизация», «умный завод», «роботизация»?' },
